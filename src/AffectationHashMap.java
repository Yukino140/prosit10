...
public class AffectationHashMap {
    ...
    public static void main(String[] args) {
        ...
        a.ajouterEmployeDepartement(new Employe(1,"Omar","fitouri","info",1),new Departement(1,"Departement Informatique",15));
        a.ajouterEmployeDepartement(new Employe(2,"Aziz","fitouri","info",1),new Departement(2,"Departement Informatique",15));
        a.ajouterEmployeDepartement(new Employe(3,"Doma","fitouri","info",1),new Departement(3,"Departement Informatique",15));
       // a.ajouterEmployeDepartement(new Employe(1,"Omar","fitouri","info",1),new Departement(3,"Departement Informatique",15));
        ...
        a.rechercherEmploye(new Employe(3,"Doma","fitouri","info",1));
