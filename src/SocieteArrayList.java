...
public class SocieteArrayList implements IGestion{
    ...
    public static void main(String[] args) {
        ...
        s.ajouterEmploye(new Employe(1,"omar","fitouri","info",5));
        s.ajouterEmploye(new Employe(2,"omar","fitouri","info",4));
        s.ajouterEmploye(new Employe(3,"omar","fitouri","info",6));
        s.displayEmploye();
